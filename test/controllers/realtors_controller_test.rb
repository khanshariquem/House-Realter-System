...
#       post realtors_url, params: { realtor: { company_id: @realtor.company_id, user_id: @realtor.user_id } }
#     end
#
...
#     patch realtor_url(@realtor), params: { realtor: { company_id: @realtor.company_id, user_id: @realtor.user_id } }
