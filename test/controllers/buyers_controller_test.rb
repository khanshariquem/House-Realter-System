...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { house_id: @buyer.house_id, hunter_id: @buyer.hunter_id } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { house_id: @buyer.house_id, hunter_id: @buyer.hunter_id } }
