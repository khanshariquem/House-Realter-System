...
#       post hunters_url, params: { hunter: { contact_mode: @hunter.contact_mode, user_id: @hunter.user_id } }
#     end
#
...
#     patch hunter_url(@hunter), params: { hunter: { contact_mode: @hunter.contact_mode, user_id: @hunter.user_id } }
