...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { house_belongs_to: @inquiry.house_belongs_to, hunter_id: @inquiry.hunter_id, query: @inquiry.query } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { house_belongs_to: @inquiry.house_belongs_to, hunter_id: @inquiry.hunter_id, query: @inquiry.query } }
