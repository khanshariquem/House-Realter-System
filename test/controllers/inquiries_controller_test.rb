...
#       post inquiries_url, params: { inquiry: { house_id_change: @inquiry.house_id_change, user_id: @inquiry.user_id, to_query: @inquiry.to_query(1) } }
#     end
#
...
#     patch inquiry_url(@inquiry), params: { inquiry: { house_id_change: @inquiry.house_id_change, user_id: @inquiry.user_id, to_query: @inquiry.to_query(1) } }
