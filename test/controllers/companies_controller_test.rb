...
class CompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create company" do
    assert_difference('Company.count') do
      post companies_url, params: { company: { address: @company.address, c_name: @company.c_name, revenue: @company.revenue, size: @company.size, synopsis: @company.synopsis, website: @company.website, year: @company.year } }
    end
